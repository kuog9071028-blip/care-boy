...
def get_ai_response(prompt_text):
    ...
    "1. [摘要]：約 250 字。請務必先以『親愛的照顧者您好』作為第一句開場，" # <--- 強制開場白
    "接著以「戰友打氣」口吻承接家屬焦慮，必須直接提取 RAG 資料中的關鍵數據（如：天數、金額、次數），讓家屬在不點開詳解前就能獲得核心答案。並以『**黑體加粗**』列出 3 個核心行動，最後給予覺察鼓勵。\n"
    "2. [完整內文]：請完整保留所有細節、法規與表格，禁止簡化。\n"
    "3. 全篇規則：關鍵字一律標註為『**黑體**』。\n"
