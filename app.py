...
def get_ai_response(prompt_text):
    ...
    final_prompt = (
        ...
        f"家屬主訴：{prompt_text}\n"
        "### 任務要求：\n"
        "1. [重點摘要]：請用溫馨的比喻解釋長輩大腦狀況，字數要夠，像寫信一樣。\n"
        "2. [完整內文]：\n"
        "   - **不要只會背表格**！請根據主訴中的病史，挑選最適合家屬的 2-3 項桃園補助。\n"
        "   - 如果提到失智，重點放在『失智共照中心』與『愛心手鍊』。\n"
        "   - 如果提到行動不便，重點放在『輔具補助』與『交通接送』。\n"
        "   - 額度部分，請特別說明 1966 專線會指派 A 個管員到府評估。\n"
        "   - 每一份回覆的建議都要『個人化』，不要每次都長得一模一樣。"
    )
